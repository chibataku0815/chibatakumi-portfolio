export declare const METABALL_PARTICLE_FLOATS = 8;
export declare const METABALL_PARTICLE_BYTES: number;
...
export interface MetaballParticleSource {
    ...
    computeForces?(positions: Float32Array, velocities: Float32Array, count: number, time: number, dt: number): {
        forces: Float32Array;
    };
