...
| 17 | ring-orbit-3d | 自動方向 | 3D ライブラリなしの傾いたリング二軸スピン | **公開済 2026-06-14** |
| 18 | disc-tumble-projection | 2D→3D | 立体に見えるのに Three.js なし — 縁を傾けて投影した点群の凸包がそのまま輪郭になる | **公開済 2026-06-14** |
