...
最終更新: 2026-06-14 / 状態: 18/18 公開（全 18 技法公開済）— drawer journal 展開レーン完結
...
|---|---|---|---|---|
| 1 | lattice-breath | 増減 | 時間差出現が生む創発カウント | **公開済 2026-06-10** |
| 2 | pulse-grid | ランダム | 「ランダム」の正体は固定順列表 1 枚 | **公開済 2026-06-10** |
| 3 | tangency-coupled-drive | 連動 | 1 自由度の接触結合から全運動が幾何導出 | **公開済 2026-06-10** |
| 4 | complement-tangent-pair | 反比例 | 保存則は半径の和（積仮説は 95× で棄却） | **公開済 2026-06-10** |
...
| 7 | whip-crawl-path-cycle | 循環 | 這いの速さはループ閉包から自動算出 — 鞭ベジェ 1 本 + 強制クロール | **公開済 2026-06-11** |
| 8 | coupled-shear-rotation | 分割 | 1 位相が群回転と対向シアを同時駆動 | **公開済 2026-06-12** |
| 9 | gather-return | 一体化と分離 | 合体も分離も gather/hold/back クリップ 1 本の遅らせ再生 + 同色 union + √成長 | **公開済 2026-06-12** |
| 10 | velocity-seeded-overshoot | 追従 | 揺れの大きさはキーを振り抜く速さがそのまま決める（遅れも行き過ぎもそこから） | **公開済 2026-06-13** |
| 11 | parallax-bob | 視差 | 共有 3 キー bob × 振幅ラダー（amp∝r 法則は棄却） | **公開済 2026-06-13** |
| 12 | arrangement-turntable | 配置移行 | 2 配置 + あいだの移動から、渦も席替えも創発 | **公開済 2026-06-13** |
| 13 | seeded-settle-jump | 時間遅延 | 波の正体は 1 本のジャンプ&着地プロファイルの時間ずらし再生 | **公開済 2026-06-14** |
| 14 | offset-stagger-conveyor | オフセット | サイズの波は同じ動きの 30f 時間ずらし複製 — 途中の戻りは右端キー 1 個 → 共有キーの補間 | **公開済 2026-06-14** |
...
| 17 | ring-orbit-3d | 自動方向 | フラットなベクターで奥行き＝傾いたリング二軸スピン×一貫パース投影 | **公開済 2026-06-14** |
| 18 | disc-tumble-projection | 2D→3D | フラットなベクターが立体に見える＝縁を傾けて投影した点群の凸包がそのまま輪郭 | **公開済 2026-06-14** |
