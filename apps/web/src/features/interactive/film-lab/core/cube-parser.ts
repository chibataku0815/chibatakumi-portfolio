/**
 * .cube LUT parser — Converts .cube file text to Float32Array for Data3DTexture
 *
 * Ported from apps/webgl-study/05-tao-tajima/src/utils/cube-parser.ts
...
export interface CubeLUT {
  ...
  data: Float32Array; // RGBA format, size^3 * 4
}
