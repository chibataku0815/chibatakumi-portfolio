import { StagedEmphasisPayoffReferenceWork } from "@/features/motion/reference-works/staged-emphasis-payoff/StagedEmphasisPayoffReferenceWork";
import { stagedEmphasisPayoffFixtures } from "@/features/motion/reference-works/staged-emphasis-payoff/fixtures";
...
export default async function StagedEmphasisPayoffPage({
  searchParams,
}: {
  ...
  return (
    <StagedEmphasisPayoffReferenceWork
      autoPlay={autoPlay}
