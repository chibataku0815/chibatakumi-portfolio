...
/**
 * @file `/filmtone` 配下のレイアウト（Package 5 Satellite canonicalization 後）。
 * @description Wave 2 D3.3 — `data-theme="dark"` wrapper を付与し、Filmtone の dark glass tokens を活性化する。
 *   旧 `/film-lab/*` および `/works/filmtone/*` から carry されたコンテンツは、Wave 1 で `[data-theme="dark"]` 配下に gated 済みのトークンを利用する。
