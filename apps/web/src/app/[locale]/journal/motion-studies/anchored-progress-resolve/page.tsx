import { AnchoredProgressResolveReferenceWork } from "@/features/motion/reference-works/anchored-progress-resolve/AnchoredProgressResolveReferenceWork";
...
export default async function AnchoredProgressResolvePage({
  searchParams,
}: {
  ...
  return (
    <AnchoredProgressResolveReferenceWork
      autoPlay={autoPlay}
